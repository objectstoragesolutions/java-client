...
public class GetAvailableDocumentEventsForApplicationResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfArrayOfBaseDocumentEventjJIl8QZi getAvailableDocumentEventsForApplicationResult;

    public GetAvailableDocumentEventsForApplicationResponse() {
    }

    public GetAvailableDocumentEventsForApplicationResponse(
           com.cleverdome.api.OperationResultOfArrayOfBaseDocumentEventjJIl8QZi getAvailableDocumentEventsForApplicationResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfArrayOfBaseDocumentEventjJIl8QZi getGetAvailableDocumentEventsForApplicationResult() {
        return getAvailableDocumentEventsForApplicationResult;
    }
     ...
     */
    public void setGetAvailableDocumentEventsForApplicationResult(com.cleverdome.api.OperationResultOfArrayOfBaseDocumentEventjJIl8QZi getAvailableDocumentEventsForApplicationResult) {
        this.getAvailableDocumentEventsForApplicationResult = getAvailableDocumentEventsForApplicationResult;
    }
