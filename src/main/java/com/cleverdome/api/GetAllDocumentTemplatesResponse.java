...
public class GetAllDocumentTemplatesResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfArrayOfDocumentTemplatewJCT_PyJf getAllDocumentTemplatesResult;

    public GetAllDocumentTemplatesResponse() {
    }

    public GetAllDocumentTemplatesResponse(
           com.cleverdome.api.OperationResultOfArrayOfDocumentTemplatewJCT_PyJf getAllDocumentTemplatesResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfArrayOfDocumentTemplatewJCT_PyJf getGetAllDocumentTemplatesResult() {
        return getAllDocumentTemplatesResult;
    }
     ...
     */
    public void setGetAllDocumentTemplatesResult(com.cleverdome.api.OperationResultOfArrayOfDocumentTemplatewJCT_PyJf getAllDocumentTemplatesResult) {
        this.getAllDocumentTemplatesResult = getAllDocumentTemplatesResult;
    }
