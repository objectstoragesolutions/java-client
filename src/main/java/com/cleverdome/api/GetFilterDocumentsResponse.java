...
public class GetFilterDocumentsResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfArrayOfDocumentwJCT_PyJf getFilterDocumentsResult;

    public GetFilterDocumentsResponse() {
    }

    public GetFilterDocumentsResponse(
           com.cleverdome.api.OperationResultOfArrayOfDocumentwJCT_PyJf getFilterDocumentsResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfArrayOfDocumentwJCT_PyJf getGetFilterDocumentsResult() {
        return getFilterDocumentsResult;
    }
     ...
     */
    public void setGetFilterDocumentsResult(com.cleverdome.api.OperationResultOfArrayOfDocumentwJCT_PyJf getFilterDocumentsResult) {
        this.getFilterDocumentsResult = getFilterDocumentsResult;
    }
