...
public class CreateDocumentTemplateResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfDocumentTemplatewJCT_PyJf createDocumentTemplateResult;

    public CreateDocumentTemplateResponse() {
    }

    public CreateDocumentTemplateResponse(
           com.cleverdome.api.OperationResultOfDocumentTemplatewJCT_PyJf createDocumentTemplateResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfDocumentTemplatewJCT_PyJf getCreateDocumentTemplateResult() {
        return createDocumentTemplateResult;
    }
     ...
     */
    public void setCreateDocumentTemplateResult(com.cleverdome.api.OperationResultOfDocumentTemplatewJCT_PyJf createDocumentTemplateResult) {
        this.createDocumentTemplateResult = createDocumentTemplateResult;
    }
