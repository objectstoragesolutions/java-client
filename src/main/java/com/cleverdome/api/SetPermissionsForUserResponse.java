...
public class SetPermissionsForUserResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfanyType setPermissionsForUserResult;

    public SetPermissionsForUserResponse() {
    }

    public SetPermissionsForUserResponse(
           com.cleverdome.api.OperationResultOfanyType setPermissionsForUserResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfanyType getSetPermissionsForUserResult() {
        return setPermissionsForUserResult;
    }
     ...
     */
    public void setSetPermissionsForUserResult(com.cleverdome.api.OperationResultOfanyType setPermissionsForUserResult) {
        this.setPermissionsForUserResult = setPermissionsForUserResult;
    }
