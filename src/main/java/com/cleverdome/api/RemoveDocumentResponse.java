...
public class RemoveDocumentResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfboolean removeDocumentResult;

    public RemoveDocumentResponse() {
    }

    public RemoveDocumentResponse(
           com.cleverdome.api.OperationResultOfboolean removeDocumentResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfboolean getRemoveDocumentResult() {
        return removeDocumentResult;
    }
     ...
     */
    public void setRemoveDocumentResult(com.cleverdome.api.OperationResultOfboolean removeDocumentResult) {
        this.removeDocumentResult = removeDocumentResult;
    }
