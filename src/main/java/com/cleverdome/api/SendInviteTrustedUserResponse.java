...
public class SendInviteTrustedUserResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfanyType sendInviteTrustedUserResult;

    public SendInviteTrustedUserResponse() {
    }

    public SendInviteTrustedUserResponse(
           com.cleverdome.api.OperationResultOfanyType sendInviteTrustedUserResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfanyType getSendInviteTrustedUserResult() {
        return sendInviteTrustedUserResult;
    }
     ...
     */
    public void setSendInviteTrustedUserResult(com.cleverdome.api.OperationResultOfanyType sendInviteTrustedUserResult) {
        this.sendInviteTrustedUserResult = sendInviteTrustedUserResult;
    }
