...
public class GetSecurityGroupsResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfSecurityGroupDatawJCT_PyJf getSecurityGroupsResult;

    public GetSecurityGroupsResponse() {
    }

    public GetSecurityGroupsResponse(
           com.cleverdome.api.OperationResultOfSecurityGroupDatawJCT_PyJf getSecurityGroupsResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfSecurityGroupDatawJCT_PyJf getGetSecurityGroupsResult() {
        return getSecurityGroupsResult;
    }
     ...
     */
    public void setGetSecurityGroupsResult(com.cleverdome.api.OperationResultOfSecurityGroupDatawJCT_PyJf getSecurityGroupsResult) {
        this.getSecurityGroupsResult = getSecurityGroupsResult;
    }
