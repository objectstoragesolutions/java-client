...
public class GetAvailableFieldsResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfArrayOfDocumentFieldwJCT_PyJf getAvailableFieldsResult;

    public GetAvailableFieldsResponse() {
    }

    public GetAvailableFieldsResponse(
           com.cleverdome.api.OperationResultOfArrayOfDocumentFieldwJCT_PyJf getAvailableFieldsResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfArrayOfDocumentFieldwJCT_PyJf getGetAvailableFieldsResult() {
        return getAvailableFieldsResult;
    }
     ...
     */
    public void setGetAvailableFieldsResult(com.cleverdome.api.OperationResultOfArrayOfDocumentFieldwJCT_PyJf getAvailableFieldsResult) {
        this.getAvailableFieldsResult = getAvailableFieldsResult;
    }
