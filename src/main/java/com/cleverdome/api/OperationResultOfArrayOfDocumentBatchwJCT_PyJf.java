/**
 * OperationResultOfArrayOfDocumentBatchwJCT_PyJf.java
 *
...
public class OperationResultOfArrayOfDocumentBatchwJCT_PyJf  implements java.io.Serializable {
    ...
    private com.cleverdome.api.DocumentBatch[] returnValue;

    public OperationResultOfArrayOfDocumentBatchwJCT_PyJf() {
    }
    ...
    public OperationResultOfArrayOfDocumentBatchwJCT_PyJf(
           ...
           com.cleverdome.api.DocumentBatch[] returnValue) {
    ...
    /**
     * Gets the message value for this OperationResultOfArrayOfDocumentBatchwJCT_PyJf.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this OperationResultOfArrayOfDocumentBatchwJCT_PyJf.
     * 
     * @param message
     */
    ...
    /**
     * Gets the permissions value for this OperationResultOfArrayOfDocumentBatchwJCT_PyJf.
     * 
     * @return permissions
     */
    ...
    /**
     * Sets the permissions value for this OperationResultOfArrayOfDocumentBatchwJCT_PyJf.
     * 
     * @param permissions
     */
    ...
    /**
     * Gets the result value for this OperationResultOfArrayOfDocumentBatchwJCT_PyJf.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this OperationResultOfArrayOfDocumentBatchwJCT_PyJf.
     * 
     * @param result
     */
    ...
    /**
     * Gets the returnValue value for this OperationResultOfArrayOfDocumentBatchwJCT_PyJf.
     * 
     * @return returnValue
     */
    public com.cleverdome.api.DocumentBatch[] getReturnValue() {
        return returnValue;
    }


    /**
     * Sets the returnValue value for this OperationResultOfArrayOfDocumentBatchwJCT_PyJf.
     * 
     * @param returnValue
     */
    public void setReturnValue(com.cleverdome.api.DocumentBatch[] returnValue) {
        this.returnValue = returnValue;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OperationResultOfArrayOfDocumentBatchwJCT_PyJf)) return false;
        OperationResultOfArrayOfDocumentBatchwJCT_PyJf other = (OperationResultOfArrayOfDocumentBatchwJCT_PyJf) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OperationResultOfArrayOfDocumentBatchwJCT_PyJf.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/CleverDomeDocumentManagement.Data", "OperationResultOfArrayOfDocumentBatchwJCT_PyJf"));
