/**
 * GetLackDeletePermissionDocuments.java
 *
...
public class GetLackDeletePermissionDocuments  implements java.io.Serializable {
    private java.lang.String sessionID;

    private java.lang.String[] documentGuids;

    public GetLackDeletePermissionDocuments() {
    }
    ...
    /**
     * Gets the sessionID value for this GetLackDeletePermissionDocuments.
     * 
     * @return sessionID
     */
    ...
    /**
     * Sets the sessionID value for this GetLackDeletePermissionDocuments.
     * 
     * @param sessionID
     */
    ...
    /**
     * Gets the documentGuids value for this GetLackDeletePermissionDocuments.
     * 
    ...
    /**
     * Sets the documentGuids value for this GetLackDeletePermissionDocuments.
     * 
     * @param documentGuids
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetLackDeletePermissionDocuments)) return false;
        GetLackDeletePermissionDocuments other = (GetLackDeletePermissionDocuments) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetLackDeletePermissionDocuments.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetLackDeletePermissionDocuments"));
