...
public class ChangeDocumentApplicationResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfanyType changeDocumentApplicationResult;

    public ChangeDocumentApplicationResponse() {
    }

    public ChangeDocumentApplicationResponse(
           com.cleverdome.api.OperationResultOfanyType changeDocumentApplicationResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfanyType getChangeDocumentApplicationResult() {
        return changeDocumentApplicationResult;
    }
     ...
     */
    public void setChangeDocumentApplicationResult(com.cleverdome.api.OperationResultOfanyType changeDocumentApplicationResult) {
        this.changeDocumentApplicationResult = changeDocumentApplicationResult;
    }
