...
public class FlxFileUpload  implements java.io.Serializable {
    private byte[] inputStream;

    public FlxFileUpload() {
    }
    ...
    /**
     * Gets the inputStream value for this FlxFileUpload.
     * 
     * @return inputStream
     */
    ...
    /**
     * Sets the inputStream value for this FlxFileUpload.
     * 
     * @param inputStream
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FlxFileUpload)) return false;
        FlxFileUpload other = (FlxFileUpload) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FlxFileUpload.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">FlxFileUpload"));
