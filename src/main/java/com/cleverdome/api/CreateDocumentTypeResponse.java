...
public class CreateDocumentTypeResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfDocumentTypewJCT_PyJf createDocumentTypeResult;

    public CreateDocumentTypeResponse() {
    }

    public CreateDocumentTypeResponse(
           com.cleverdome.api.OperationResultOfDocumentTypewJCT_PyJf createDocumentTypeResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfDocumentTypewJCT_PyJf getCreateDocumentTypeResult() {
        return createDocumentTypeResult;
    }
     ...
     */
    public void setCreateDocumentTypeResult(com.cleverdome.api.OperationResultOfDocumentTypewJCT_PyJf createDocumentTypeResult) {
        this.createDocumentTypeResult = createDocumentTypeResult;
    }
