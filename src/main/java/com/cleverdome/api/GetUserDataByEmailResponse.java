...
public class GetUserDataByEmailResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfUserDatawJCT_PyJf getUserDataByEmailResult;

    public GetUserDataByEmailResponse() {
    }

    public GetUserDataByEmailResponse(
           com.cleverdome.api.OperationResultOfUserDatawJCT_PyJf getUserDataByEmailResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfUserDatawJCT_PyJf getGetUserDataByEmailResult() {
        return getUserDataByEmailResult;
    }
     ...
     */
    public void setGetUserDataByEmailResult(com.cleverdome.api.OperationResultOfUserDatawJCT_PyJf getUserDataByEmailResult) {
        this.getUserDataByEmailResult = getUserDataByEmailResult;
    }
