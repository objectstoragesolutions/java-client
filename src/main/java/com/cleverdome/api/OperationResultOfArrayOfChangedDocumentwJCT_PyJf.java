/**
 * OperationResultOfArrayOfChangedDocumentwJCT_PyJf.java
 *
...
public class OperationResultOfArrayOfChangedDocumentwJCT_PyJf  implements java.io.Serializable {
    ...
    private com.cleverdome.api.ChangedDocument[] returnValue;

    public OperationResultOfArrayOfChangedDocumentwJCT_PyJf() {
    }
    ...
    public OperationResultOfArrayOfChangedDocumentwJCT_PyJf(
           ...
           com.cleverdome.api.ChangedDocument[] returnValue) {
    ...
    /**
     * Gets the message value for this OperationResultOfArrayOfChangedDocumentwJCT_PyJf.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this OperationResultOfArrayOfChangedDocumentwJCT_PyJf.
     * 
     * @param message
     */
    ...
    /**
     * Gets the permissions value for this OperationResultOfArrayOfChangedDocumentwJCT_PyJf.
     * 
     * @return permissions
     */
    ...
    /**
     * Sets the permissions value for this OperationResultOfArrayOfChangedDocumentwJCT_PyJf.
     * 
     * @param permissions
     */
    ...
    /**
     * Gets the result value for this OperationResultOfArrayOfChangedDocumentwJCT_PyJf.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this OperationResultOfArrayOfChangedDocumentwJCT_PyJf.
     * 
     * @param result
     */
    ...
    /**
     * Gets the returnValue value for this OperationResultOfArrayOfChangedDocumentwJCT_PyJf.
     * 
     * @return returnValue
     */
    public com.cleverdome.api.ChangedDocument[] getReturnValue() {
        return returnValue;
    }


    /**
     * Sets the returnValue value for this OperationResultOfArrayOfChangedDocumentwJCT_PyJf.
     * 
     * @param returnValue
     */
    public void setReturnValue(com.cleverdome.api.ChangedDocument[] returnValue) {
        this.returnValue = returnValue;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OperationResultOfArrayOfChangedDocumentwJCT_PyJf)) return false;
        OperationResultOfArrayOfChangedDocumentwJCT_PyJf other = (OperationResultOfArrayOfChangedDocumentwJCT_PyJf) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OperationResultOfArrayOfChangedDocumentwJCT_PyJf.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/CleverDomeDocumentManagement.Data", "OperationResultOfArrayOfChangedDocumentwJCT_PyJf"));
