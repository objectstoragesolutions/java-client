...
public class AddFieldToDocumentTypeResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfDocumentFieldwJCT_PyJf addFieldToDocumentTypeResult;

    public AddFieldToDocumentTypeResponse() {
    }

    public AddFieldToDocumentTypeResponse(
           com.cleverdome.api.OperationResultOfDocumentFieldwJCT_PyJf addFieldToDocumentTypeResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfDocumentFieldwJCT_PyJf getAddFieldToDocumentTypeResult() {
        return addFieldToDocumentTypeResult;
    }
     ...
     */
    public void setAddFieldToDocumentTypeResult(com.cleverdome.api.OperationResultOfDocumentFieldwJCT_PyJf addFieldToDocumentTypeResult) {
        this.addFieldToDocumentTypeResult = addFieldToDocumentTypeResult;
    }
