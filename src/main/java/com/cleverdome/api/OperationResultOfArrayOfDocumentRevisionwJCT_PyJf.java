...
public class OperationResultOfArrayOfDocumentRevisionwJCT_PyJf  extends com.cleverdome.api.OperationResult  implements java.io.Serializable {
    private com.cleverdome.api.UserPermissions permissions;

    private com.cleverdome.api.DocumentRevision[] returnValue;
    ...
    public OperationResultOfArrayOfDocumentRevisionwJCT_PyJf(
           ...
           com.cleverdome.api.DocumentRevision[] returnValue) {
        super(
            message,
            result);
     ...
     * @return returnValue
     */
    public com.cleverdome.api.DocumentRevision[] getReturnValue() {
        return returnValue;
    }
     ...
     * @param returnValue
     */
    public void setReturnValue(com.cleverdome.api.DocumentRevision[] returnValue) {
        this.returnValue = returnValue;
    }
