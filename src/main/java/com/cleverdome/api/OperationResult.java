...
public class OperationResult  implements java.io.Serializable {
    ...
    /**
     * Gets the result value for this OperationResult.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this OperationResult.
     * 
     * @param result
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/CleverDomeDocumentManagement.Data", "OperationResult"));
