...
public class CopyMetadataToNextBatchItemResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfanyType copyMetadataToNextBatchItemResult;

    public CopyMetadataToNextBatchItemResponse() {
    }

    public CopyMetadataToNextBatchItemResponse(
           com.cleverdome.api.OperationResultOfanyType copyMetadataToNextBatchItemResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfanyType getCopyMetadataToNextBatchItemResult() {
        return copyMetadataToNextBatchItemResult;
    }
     ...
     */
    public void setCopyMetadataToNextBatchItemResult(com.cleverdome.api.OperationResultOfanyType copyMetadataToNextBatchItemResult) {
        this.copyMetadataToNextBatchItemResult = copyMetadataToNextBatchItemResult;
    }
