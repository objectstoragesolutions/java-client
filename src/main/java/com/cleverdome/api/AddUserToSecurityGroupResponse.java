...
public class AddUserToSecurityGroupResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfUserDatawJCT_PyJf addUserToSecurityGroupResult;

    public AddUserToSecurityGroupResponse() {
    }

    public AddUserToSecurityGroupResponse(
           com.cleverdome.api.OperationResultOfUserDatawJCT_PyJf addUserToSecurityGroupResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfUserDatawJCT_PyJf getAddUserToSecurityGroupResult() {
        return addUserToSecurityGroupResult;
    }
     ...
     */
    public void setAddUserToSecurityGroupResult(com.cleverdome.api.OperationResultOfUserDatawJCT_PyJf addUserToSecurityGroupResult) {
        this.addUserToSecurityGroupResult = addUserToSecurityGroupResult;
    }
