...
public class RenameMetadataHierarchyNodeResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfboolean renameMetadataHierarchyNodeResult;

    public RenameMetadataHierarchyNodeResponse() {
    }

    public RenameMetadataHierarchyNodeResponse(
           com.cleverdome.api.OperationResultOfboolean renameMetadataHierarchyNodeResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfboolean getRenameMetadataHierarchyNodeResult() {
        return renameMetadataHierarchyNodeResult;
    }
     ...
     */
    public void setRenameMetadataHierarchyNodeResult(com.cleverdome.api.OperationResultOfboolean renameMetadataHierarchyNodeResult) {
        this.renameMetadataHierarchyNodeResult = renameMetadataHierarchyNodeResult;
    }
