...
public class GetBatchItemsResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfArrayOfguiduHEDJ7Dj getBatchItemsResult;

    public GetBatchItemsResponse() {
    }

    public GetBatchItemsResponse(
           com.cleverdome.api.OperationResultOfArrayOfguiduHEDJ7Dj getBatchItemsResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfArrayOfguiduHEDJ7Dj getGetBatchItemsResult() {
        return getBatchItemsResult;
    }
     ...
     */
    public void setGetBatchItemsResult(com.cleverdome.api.OperationResultOfArrayOfguiduHEDJ7Dj getBatchItemsResult) {
        this.getBatchItemsResult = getBatchItemsResult;
    }
