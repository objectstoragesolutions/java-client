...
public class DocumentType  implements java.io.Serializable {
    ...
    /**
     * Gets the ID value for this DocumentType.
     * 
     * @return ID
     */
    ...
    /**
     * Sets the ID value for this DocumentType.
     * 
     * @param ID
     */
    ...
    /**
     * Gets the name value for this DocumentType.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this DocumentType.
     * 
     * @param name
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/CleverDomeDocumentManagement.Data", "DocumentType"));
