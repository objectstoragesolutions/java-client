...
public class AddMetadataHierarchyNodeResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfArrayOfguiduHEDJ7Dj addMetadataHierarchyNodeResult;

    public AddMetadataHierarchyNodeResponse() {
    }

    public AddMetadataHierarchyNodeResponse(
           com.cleverdome.api.OperationResultOfArrayOfguiduHEDJ7Dj addMetadataHierarchyNodeResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfArrayOfguiduHEDJ7Dj getAddMetadataHierarchyNodeResult() {
        return addMetadataHierarchyNodeResult;
    }
     ...
     */
    public void setAddMetadataHierarchyNodeResult(com.cleverdome.api.OperationResultOfArrayOfguiduHEDJ7Dj addMetadataHierarchyNodeResult) {
        this.addMetadataHierarchyNodeResult = addMetadataHierarchyNodeResult;
    }
