...
public class ApplicationType  implements java.io.Serializable {
    ...
    /**
     * Gets the ID value for this ApplicationType.
     * 
     * @return ID
     */
    ...
    /**
     * Sets the ID value for this ApplicationType.
     * 
     * @param ID
     */
    ...
    /**
     * Gets the name value for this ApplicationType.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this ApplicationType.
     * 
     * @param name
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/CleverDomeDocumentManagement.Data", "ApplicationType"));
