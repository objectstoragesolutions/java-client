...
public class UploadFileResponse  implements java.io.Serializable {
    private java.lang.String uploadFileResult;

    public UploadFileResponse() {
    }

    public UploadFileResponse(
           java.lang.String uploadFileResult) {
     ...
     */
    public java.lang.String getUploadFileResult() {
        return uploadFileResult;
    }
     ...
     */
    public void setUploadFileResult(java.lang.String uploadFileResult) {
        this.uploadFileResult = uploadFileResult;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            ((this.uploadFileResult==null && other.getUploadFileResult()==null) || 
             (this.uploadFileResult!=null &&
              this.uploadFileResult.equals(other.getUploadFileResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        if (getUploadFileResult() != null) {
            _hashCode += getUploadFileResult().hashCode();
        }
