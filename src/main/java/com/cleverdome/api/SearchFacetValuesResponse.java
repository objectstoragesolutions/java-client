...
public class SearchFacetValuesResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfstring searchFacetValuesResult;

    public SearchFacetValuesResponse() {
    }

    public SearchFacetValuesResponse(
           com.cleverdome.api.OperationResultOfstring searchFacetValuesResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfstring getSearchFacetValuesResult() {
        return searchFacetValuesResult;
    }
     ...
     */
    public void setSearchFacetValuesResult(com.cleverdome.api.OperationResultOfstring searchFacetValuesResult) {
        this.searchFacetValuesResult = searchFacetValuesResult;
    }
