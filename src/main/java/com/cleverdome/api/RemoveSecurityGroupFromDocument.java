/**
 * RemoveSecurityGroupFromDocument.java
 *
...
public class RemoveSecurityGroupFromDocument  implements java.io.Serializable {
    ...
    public RemoveSecurityGroupFromDocument() {
    }
    ...
    /**
     * Gets the sessionID value for this RemoveSecurityGroupFromDocument.
     * 
     * @return sessionID
     */
    ...
    /**
     * Sets the sessionID value for this RemoveSecurityGroupFromDocument.
     * 
     * @param sessionID
     */
    ...
    /**
     * Gets the documentGuid value for this RemoveSecurityGroupFromDocument.
     * 
     * @return documentGuid
     */
    ...
    /**
     * Sets the documentGuid value for this RemoveSecurityGroupFromDocument.
     * 
     * @param documentGuid
     */
    ...
    /**
     * Gets the securityGroupID value for this RemoveSecurityGroupFromDocument.
     * 
    ...
    /**
     * Sets the securityGroupID value for this RemoveSecurityGroupFromDocument.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RemoveSecurityGroupFromDocument)) return false;
        RemoveSecurityGroupFromDocument other = (RemoveSecurityGroupFromDocument) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RemoveSecurityGroupFromDocument.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">RemoveSecurityGroupFromDocument"));
