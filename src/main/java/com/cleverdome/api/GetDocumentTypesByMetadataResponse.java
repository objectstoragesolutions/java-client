...
public class GetDocumentTypesByMetadataResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfArrayOfDocumentTypewJCT_PyJf getDocumentTypesByMetadataResult;

    public GetDocumentTypesByMetadataResponse() {
    }

    public GetDocumentTypesByMetadataResponse(
           com.cleverdome.api.OperationResultOfArrayOfDocumentTypewJCT_PyJf getDocumentTypesByMetadataResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfArrayOfDocumentTypewJCT_PyJf getGetDocumentTypesByMetadataResult() {
        return getDocumentTypesByMetadataResult;
    }
     ...
     */
    public void setGetDocumentTypesByMetadataResult(com.cleverdome.api.OperationResultOfArrayOfDocumentTypewJCT_PyJf getDocumentTypesByMetadataResult) {
        this.getDocumentTypesByMetadataResult = getDocumentTypesByMetadataResult;
    }
