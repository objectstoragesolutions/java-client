...
public class GetDocumentMetadataHierarchyResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfArrayOfBaseDocumentMetadataHierarchyElementjJIl8QZi getDocumentMetadataHierarchyResult;

    public GetDocumentMetadataHierarchyResponse() {
    }

    public GetDocumentMetadataHierarchyResponse(
           com.cleverdome.api.OperationResultOfArrayOfBaseDocumentMetadataHierarchyElementjJIl8QZi getDocumentMetadataHierarchyResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfArrayOfBaseDocumentMetadataHierarchyElementjJIl8QZi getGetDocumentMetadataHierarchyResult() {
        return getDocumentMetadataHierarchyResult;
    }
     ...
     */
    public void setGetDocumentMetadataHierarchyResult(com.cleverdome.api.OperationResultOfArrayOfBaseDocumentMetadataHierarchyElementjJIl8QZi getDocumentMetadataHierarchyResult) {
        this.getDocumentMetadataHierarchyResult = getDocumentMetadataHierarchyResult;
    }
