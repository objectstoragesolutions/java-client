...
public class AddDocumentFieldResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfint addDocumentFieldResult;

    public AddDocumentFieldResponse() {
    }

    public AddDocumentFieldResponse(
           com.cleverdome.api.OperationResultOfint addDocumentFieldResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfint getAddDocumentFieldResult() {
        return addDocumentFieldResult;
    }
     ...
     */
    public void setAddDocumentFieldResult(com.cleverdome.api.OperationResultOfint addDocumentFieldResult) {
        this.addDocumentFieldResult = addDocumentFieldResult;
    }
