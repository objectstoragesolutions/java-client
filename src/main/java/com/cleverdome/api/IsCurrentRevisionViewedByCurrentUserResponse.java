...
public class IsCurrentRevisionViewedByCurrentUserResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfboolean isCurrentRevisionViewedByCurrentUserResult;

    public IsCurrentRevisionViewedByCurrentUserResponse() {
    }

    public IsCurrentRevisionViewedByCurrentUserResponse(
           com.cleverdome.api.OperationResultOfboolean isCurrentRevisionViewedByCurrentUserResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfboolean getIsCurrentRevisionViewedByCurrentUserResult() {
        return isCurrentRevisionViewedByCurrentUserResult;
    }
     ...
     */
    public void setIsCurrentRevisionViewedByCurrentUserResult(com.cleverdome.api.OperationResultOfboolean isCurrentRevisionViewedByCurrentUserResult) {
        this.isCurrentRevisionViewedByCurrentUserResult = isCurrentRevisionViewedByCurrentUserResult;
    }
