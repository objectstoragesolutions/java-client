...
public class GetAllSearcheableFieldsResponse  implements java.io.Serializable {
    private com.cleverdome.api.OperationResultOfArrayOfSearcheableMetadataTypewJCT_PyJf getAllSearcheableFieldsResult;

    public GetAllSearcheableFieldsResponse() {
    }

    public GetAllSearcheableFieldsResponse(
           com.cleverdome.api.OperationResultOfArrayOfSearcheableMetadataTypewJCT_PyJf getAllSearcheableFieldsResult) {
     ...
     */
    public com.cleverdome.api.OperationResultOfArrayOfSearcheableMetadataTypewJCT_PyJf getGetAllSearcheableFieldsResult() {
        return getAllSearcheableFieldsResult;
    }
     ...
     */
    public void setGetAllSearcheableFieldsResult(com.cleverdome.api.OperationResultOfArrayOfSearcheableMetadataTypewJCT_PyJf getAllSearcheableFieldsResult) {
        this.getAllSearcheableFieldsResult = getAllSearcheableFieldsResult;
    }
