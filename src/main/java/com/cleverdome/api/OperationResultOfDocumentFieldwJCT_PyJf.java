/**
 * OperationResultOfDocumentFieldwJCT_PyJf.java
 *
...
public class OperationResultOfDocumentFieldwJCT_PyJf  implements java.io.Serializable {
    ...
    public OperationResultOfDocumentFieldwJCT_PyJf() {
    }
    ...
    /**
     * Gets the message value for this OperationResultOfDocumentFieldwJCT_PyJf.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this OperationResultOfDocumentFieldwJCT_PyJf.
     * 
     * @param message
     */
    ...
    /**
     * Gets the permissions value for this OperationResultOfDocumentFieldwJCT_PyJf.
     * 
     * @return permissions
     */
    ...
    /**
     * Sets the permissions value for this OperationResultOfDocumentFieldwJCT_PyJf.
     * 
     * @param permissions
     */
    ...
    /**
     * Gets the result value for this OperationResultOfDocumentFieldwJCT_PyJf.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this OperationResultOfDocumentFieldwJCT_PyJf.
     * 
     * @param result
     */
    ...
    /**
     * Gets the returnValue value for this OperationResultOfDocumentFieldwJCT_PyJf.
     * 
     * @return returnValue
     */
    ...
    /**
     * Sets the returnValue value for this OperationResultOfDocumentFieldwJCT_PyJf.
     * 
     * @param returnValue
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OperationResultOfDocumentFieldwJCT_PyJf)) return false;
        OperationResultOfDocumentFieldwJCT_PyJf other = (OperationResultOfDocumentFieldwJCT_PyJf) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OperationResultOfDocumentFieldwJCT_PyJf.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/CleverDomeDocumentManagement.Data", "OperationResultOfDocumentFieldwJCT_PyJf"));
